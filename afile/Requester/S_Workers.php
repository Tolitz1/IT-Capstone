...
<section class="section-5" style="margin-top: 10%;">
      ...
      <div class="row gx-0">
        ...
        <p class="bg-dark text-white p-3" style="border-radius: 2px; font-size:20px">Salon Workers</p>
        <?php

          if(isset($_POST['search'])){

              $valueToSearch = $_POST['valueToSearch'];
              $query = "SELECT * FROM workerslogin_tb WHERE Concat (w_fname,w_lname,w_municipality,w_role='Salon Worker') LIKE '%".$valueToSearch."%'";
              $search_result = filterTable($query);

            }else
            {
                $query = "SELECT * FROM workerslogin_tb where w_role='Salon Worker' AND w_status = 'approved' ORDER BY w_login_id DESC";
                $search_result = filterTable($query);
            }
    ...
    <button class="btn1 mb-5"><a href="./r_index.php">Back</a></button>
