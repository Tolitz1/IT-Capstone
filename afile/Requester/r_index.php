...
<nav class="navbar navbar-expand-lg navbar-light bg-dark">
  ...
  <a class="navbar-brand mx-5" href="r_index.php">Handyman-Salon</a>
...
<div class="collapse navbar-collapse text-center mx-5" id="navbarNav">
  <ul class="navbar-nav me-auto">
    <li class="nav-item active">
      <a class="nav-link" href="r_index.php">Home</a>
    </li>
...
<!--     <button class="nav-link mx-3 " type="button" id="login" data-toggle="modal" data-target="#myModal1">
    ...
    <button class="nav-link mx-3 " type="button" id="signup"  data-toggle="modal" data-target="#">
      <a style="color: white; text-decoration:none;" href="RequesterProfile.php">Profile</a>
      </button>
    </li>
  </ul>
</div>
  ...
  <div class="row">
    ...
    <div class="col-md-6">
      <div class="panel">
        ...
        <button type="button" class="btn btn-outline-dark"> <a style="color: black; text-decoration:none" href="../Requester/H_Workers.php">View More</a></button>
      </div>
    </div>
  </div>
</div>
    ...
    <div class="row">
      <div class="col-md-6">
        <div class="panel">
          ...
          <button type="button" class="btn btn-outline-dark"> <a style="color: black; text-decoration:none" href="../Requester/S_Workers.php">View More</a></button>
        </div>
      </div>
      <div class="col-md-6">
      <div class="S2">
