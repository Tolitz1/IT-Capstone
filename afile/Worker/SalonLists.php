...
<section class="section-5" style="margin-top: 10%;">
      ...
      <div class="row gx-0">
        ...
        <p class="bg-dark text-white p-3" style="border-radius: 2px; font-size:25px">Salon Workers</p>
        <?php
          $sql= "SELECT * FROM workerslogin_tb WHERE w_role ='Salon Worker'";
          ...
          <div class="center">
             <div class="form-row">
              <div class="col-lg-6"></div>
                ...
                <p style="color: black;">Kindyly Sign-Up first before request an appointmnet.</p>
            </div>
          </div>  
        </div>
        <!---- Modal footer -->
